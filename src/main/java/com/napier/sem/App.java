...
public class App {
    public static void main(String[] args) {
        ...
        a.displayDepartmentNo(dep);

        // Extract salary by department information
        ArrayList<Employee> employees2 = a.getSalariesByDepartment(dep);

        //Display Salary Information in Specific department
        a.printSalariesByDepartment(employees2);
